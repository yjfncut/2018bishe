...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="blank-page">
					<h2>轨迹数据集介绍</h2>
					<p>微软亚洲研究院的GelLife数据集由182位用户五年间（2007年4月至2012年8月）运动轨迹组成。该数据集的GPS轨迹由一系列时间戳点表示，每一点包含纬度、经度和高度信息。该数据集包含17621个轨迹与总距离1292951km和总持续时间为50176小时。这些轨迹是由不同的GPS记录器记录，并且有多种采样率。91.5%的轨迹以密集的形式记录，例如每1～5秒或每5到10米每一点。
						这个数据集记录的一个范围广泛的用户的户外运动，不仅包括生活作息和回家工作，也有一些娱乐和体育活动，如购物、观光、餐饮、徒步旅行、骑自行车。该轨迹数据集可用于移动模式挖掘、用户活动识别、基于位置的社交网络、位置隐私和位置推荐等多个领域。
						尽管这一数据广泛分布在中国30个城市其中一些城市位于美国和欧洲，大部分的数据是在北京采集，中国。图1绘制了这个数据集在北京的分布（热图）。位于热棒右侧的图形表示位置上生成的点的数目。
					</p>

					<div class="gallery-grids galry">
						<div class="col-md-4 gallery-grid">
							<a href="images/tu1.png" class="swipebox"><span class="rollover1"> </span></a>
							<img src="images/tu1.png" class="img-responsive" alt="/">
						</div>
						<div class="col-md-4 gallery-grid">
							<a href="images/tu2.png" class="swipebox"><span class="rollover1"> </span></a>
							<img src="images/tu2.png" class="img-responsive" alt="/">
						</div>
						<div class="col-md-4 gallery-grid">
							<a href="images/tu3.png" class="swipebox"><span class="rollover1"> </span></a>
							<img src="images/tu3.png" class="img-responsive" alt="/">
						</div>
					</div>
		...
		<div id="page-wrapper1">
			<div class="main-page">
				<div class="blank-page">
			<p>在数据收集程序中，一部分用户已经携带GPS记录器多年，而另一些用户只有几个星期的轨迹数据集。右图为不同类型的轨迹数据介绍
			</p>
		</div>
